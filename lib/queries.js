module.exports = {
  ...
  insertImtd: 'INSERT INTO imtd_niki (station_id, flood_warning_area, flood_warning_type, direction, level) SELECT $1, $2, $3, $4, $5 WHERE NOT EXISTS (SELECT 1 FROM imtd_niki WHERE station_id = $1 AND flood_warning_area = $2 AND flood_warning_type = $3 AND direction = $4 AND level = $5);'
}
