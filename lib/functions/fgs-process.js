...
module.exports.handler = async (event) => {
  ...
  const { statement } = await wreck.request('get', 'https://api.ffc-environment-agency.fgs.metoffice.gov.uk/api/public/v3/statements/latest', {
    json: true,
    timeout: 30000,
    headers: {
      'x-api-key': process.env.LFW_DATA_FGS_KEY
    }
  }, true)
